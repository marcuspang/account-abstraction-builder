...
const AddModifierButton = () => {
  ...
  return (
    <>
      ...
      >
        <button
          className="border-2 border-slate-300 rounded-full w-24 h-24 flex mx-auto items-center justify-center text-slate-300 transition-all group relative hover:border-slate-400 hover:text-slate-400"
          role="button"
          onClick={openModal}
        >
