				...
				<div className="col-span-3">
					<ul className="pb-12">
						{plugins.map(({ id, displayName, modifyCode, protocol }) => (
							<li
								key={id}
								className="border-2 py-2 px-4 rounded border-slate-400 hover:bg-slate-900 active:opacity-80 transition-colors hover:cursor-pointer text-slate-700 hover:text-slate-200"
								onClick={() => {
